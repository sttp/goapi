...
//
//     Generated on 2021 October 07 18:51:47 UTC
// </auto-generated>
//---------------------------------------------------------

//******************************************************************************************************
//  DataRowHashSet_test.go - Gbtc
//
...
func random() *DataRow {
	...
	table := dataSet.CreateTable("Test" + strconv.Itoa(rand.Intn(10000)))
	table.AddColumn(table.CreateColumn("Col1", DataType.Boolean, ""))
	table.AddColumn(table.CreateColumn("Col2", DataType.String, ""))
	table.AddColumn(table.CreateColumn("Col3", DataType.Guid, ""))
	dataSet.AddTable(table)

	dataRow := table.CreateRow()
	dataRow.SetValueByName("Col1", true)
	dataRow.SetValueByName("Col2", "Value"+strconv.Itoa(rand.Intn(10000)))
	dataRow.SetValueByName("Col3", guid.New())
...
func TestNewDataRowHashSet(t *testing.T) {
	set := NewDataRowHashSet([]*DataRow{random(), random(), random(), random()})

	if len(set) != 4 {
		t.Fatalf("NewDataRowHashSet: len != 4")
	}
}

func TestAdd(t *testing.T) {
	set := NewDataRowHashSet([]*DataRow{})
...
func TestRemoveWhere(t *testing.T) {
	...
	if count := set.RemoveWhere(func(item *DataRow) bool { return item == empty }); count != 1 {
...
func TestClear(t *testing.T) {
	set := NewDataRowHashSet([]*DataRow{random(), random(), random()})
...
func TestExceptWithSet(t *testing.T) {
	set1 := NewDataRowHashSet([]*DataRow{random(), random(), random(), random()})
	set2 := NewDataRowHashSet(set1.Keys())
...
func TestIntersectWithSet(t *testing.T) {
	set1 := NewDataRowHashSet([]*DataRow{random(), random(), random(), random()})
	set2 := NewDataRowHashSet(set1.Keys())
	set3 := NewDataRowHashSet(set1.Keys())
