...
//
//     Generated on 2021 October 07 19:03:01 UTC
// </auto-generated>
//---------------------------------------------------------

//******************************************************************************************************
//  DataRowHashSet.go - Gbtc
//
...
// DataRowHashSet represents a distinct collection of *DataRow values, i.e., a set.
// A DataRowHashSet is not sorted and will not contain duplicate elements.
// The methods of the DataRowHashSet are not intrinsically thread-safe procedures,
// to guarantee thread safety, you should initiate a lock before calling a method.
type DataRowHashSet map[*DataRow]void

// NewDataRowHashSet creates a new set containing all elements in the specified slice.
// Returns a new DataRowHashSet that contain the specified slice items.
func NewDataRowHashSet(items []*DataRow) DataRowHashSet {
	hs := make(DataRowHashSet, len(items))
	hs.UnionWith(items)
	return hs
}
...
func (hs DataRowHashSet) IntersectWith(other []*DataRow) {
	hs.IntersectWithSet(NewDataRowHashSet(other))
}
...
func (hs DataRowHashSet) IsSubsetOf(other []*DataRow) bool {
	return hs.IsSubsetOfSet(NewDataRowHashSet(other))
}
...
func (hs DataRowHashSet) IsProperSubsetOf(other []*DataRow) bool {
	return hs.IsProperSubsetOfSet(NewDataRowHashSet(other))
}
