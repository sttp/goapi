// Code generated from HashSet_test.tt by T4 template. DO NOT EDIT.
...
func TestNewHashSet(t *testing.T) {
	set := NewHashSet([]*DataRow{random(), random(), random(), random()})
...
func TestClear(t *testing.T) {
	set := NewHashSet([]*DataRow{random(), random(), random()})
...
func TestExceptWithSet(t *testing.T) {
	set1 := NewHashSet([]*DataRow{random(), random(), random(), random()})
